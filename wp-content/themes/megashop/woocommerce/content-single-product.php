...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( post_class(), $product ); ?>>
    ...
    if ($single_layout == 'fixed') {
        wc_get_template_part('single-product-content', 'fixed');
    } elseif ($single_layout == 'image_center') {
        wc_get_template_part('single-product-content', 'image_center');
    } else {
        ?>
