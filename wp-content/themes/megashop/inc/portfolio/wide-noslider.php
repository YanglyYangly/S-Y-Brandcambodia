<div class="portfolio_wide clearfix">
    ...
    ?>
    <div class="portfolio-detail-title columns">
    ...
    <?php if (get_post_meta(get_the_ID(), 'tt_portfolio-client', true) != "") { ?>
                ...
                <li class="clearfix port-att"><strong><?php _e('Tags', 'megashop'); ?></strong> <span><?php $taxonomy = strip_tags(get_the_term_list($post->ID, 'portfolio_filter', '', ', ', ''));
            echo esc_html($taxonomy); ?></span></li>
...
<?php } ?>
    <div class="portfolio-detail-description <?php if (get_post_meta(get_the_ID(), 'tt_portfolio-details', true) == 1) {
    echo 'col-sm-8 padding_right_0';
} else {
    echo 'col-sm-12 padding_0';
} ?> columns">
