...
function megashop_register_required_plugins() {
    ...
    $plugins = array(
        array(
			...
			'source'             => 'https://wordpress.templatetrip.com/pkg-plugins/TTeximport.zip', // The plugin source.
        ...
        array(
			...
			'source'             => 'https://wordpress.templatetrip.com/pkg-plugins/TTCustomShortcode.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
         ...
         array(
			...
			'source'             => 'https://wordpress.templatetrip.com/pkg-plugins/TTCustomPostType.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
         ...
         array(
			...
			'source'             => 'https://wordpress.templatetrip.com/pkg-plugins/TTAutoInstall.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		...
		array(
            'name' => esc_html__('WooCommerce added to cart popup (Ajax)', 'shade'),
		...
		array(
            'name' => esc_html__('Meta Box', 'megashop'),
            'slug' => 'meta-box',
            'required' => false,
        ),
        array(
		...
		array(
            'name' => esc_html__('Widget Importer & Exporter', 'megashop'),
		...
		array(
            ...
            'required' => false,
			'source'   => 'https://wordpress.templatetrip.com/pkg-plugins/woocommerce-accepted-payment-methods.zip', // The plugin source.
        ),
        array(
            'name' => esc_html__('Envato Market', 'megashop'),
            'slug' => 'envato-market',
            'required' => false,
			'source'   => 'https://wordpress.templatetrip.com/pkg-plugins/envato-market.zip', // The plugin source.
        ),
    );
