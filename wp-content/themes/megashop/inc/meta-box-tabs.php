...
if ( ! class_exists( 'RWMB_Tabs' ) )
{
	class RWMB_Tabs
	{
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( 'rwmb-tabs', get_template_directory_uri() . '/admin/metabox-tab/tabs.css' );
			wp_enqueue_script( 'rwmb-tabs', get_template_directory_uri() . '/admin/metabox-tab/tabs.js', array( 'jquery' ), '0.1', true );
		}
