...
?>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_author' )); ?>"><?php _e( 'Display Blog Author?','megashop' ); ?></label></p>
...
function register_TT_Widget_LatestBlog() {
    register_widget( 'TT_Widget_LatestBlog' );
}
add_action( 'widgets_init', 'register_TT_Widget_LatestBlog' );